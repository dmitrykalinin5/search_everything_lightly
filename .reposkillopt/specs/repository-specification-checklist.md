...
- [x] CHK001 — All 19 required sections are present in order.
- [x] CHK002 — Implementation claims cite local evidence and distinguish remaining unknowns.
- [x] CHK003 — Entry points, settings, dependencies and command targets are enumerated.
- [x] CHK004 — Control/data flow diagrams have accompanying source references.
- [x] CHK005 — No database schema is invented; only GSettings persists extension data.
- [x] CHK006 — Named symbols are mechanically extracted to symbols.json and appended by file.
