...
Локальный поиск приложений, файлов и папок в компактном окне GNOME Shell. Версия **0.2.1**, Fedora / GNOME Shell **49**, Wayland. Английский интерфейс и русский перевод через gettext.
